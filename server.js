...
const FOXPAY_UPGRADE_CARDS = [
  // --- SOPORTE (Antes Marketing) ---
  { id: 'tg_channel', name: 'Suministro Eléctrico Básico', category: 'support', baseCost: 100, baseProfit: 10, costMultiplier: 1.18, requires: null },
  { id: 'wa_group', name: 'Ventiladores de Chasis', category: 'support', baseCost: 250, baseProfit: 25, costMultiplier: 1.18, requires: { type: 'card', id: 'tg_channel', level: 3 } },
  { id: 'seo_strategy', name: 'Fuente de Poder 80 Plus Gold', category: 'support', baseCost: 500, baseProfit: 55, costMultiplier: 1.18, requires: { type: 'card', id: 'wa_group', level: 2 } },
  { id: 'tiktok_campaign', name: 'Extractores de Aire Industriales', category: 'support', baseCost: 800, baseProfit: 85, costMultiplier: 1.18, requires: { type: 'card', id: 'seo_strategy', level: 4 } },
  { id: 'youtube_ads', name: 'Doble Fuente de Alimentación', category: 'support', baseCost: 1200, baseProfit: 130, costMultiplier: 1.18, requires: { type: 'card', id: 'tiktok_campaign', level: 5 } },
  { id: 'community_airdrop', name: 'Disipadores de Cobre Premium', category: 'support', baseCost: 1800, baseProfit: 200, costMultiplier: 1.18, requires: { type: 'card', id: 'youtube_ads', level: 4 } },
  { id: 'influencer_mkt', name: 'Kit de Enfriamiento Líquido', category: 'support', baseCost: 2500, baseProfit: 300, costMultiplier: 1.18, requires: { type: 'invites', count: 2 } },
  { id: 'metaverse_billboard', name: 'Subestación Eléctrica Propia', category: 'support', baseCost: 4500, baseProfit: 550, costMultiplier: 1.18, requires: { type: 'card', id: 'influencer_mkt', level: 5 } },
  { id: 'ambassador_program', name: 'Inmersión en Líquido Dieléctrico', category: 'support', baseCost: 8000, baseProfit: 1000, costMultiplier: 1.18, requires: { type: 'invites', count: 5 } },
  { id: 'esports_sponsor', name: 'Planta de Energía Solar', category: 'support', baseCost: 15000, baseProfit: 2000, costMultiplier: 1.18, requires: { type: 'card', id: 'ambassador_program', level: 5 } },

  // --- HARDWARE (Antes Tecnología) ---
  { id: 'local_servers', name: 'Memoria RAM DDR5', category: 'technology', baseCost: 150, baseProfit: 15, costMultiplier: 1.18, requires: null },
  { id: 'smart_contract_audit', name: 'Placa Madre de 8 GPUs', category: 'technology', baseCost: 350, baseProfit: 35, costMultiplier: 1.18, requires: { type: 'card', id: 'local_servers', level: 3 } },
  { id: 'aws_cloud', name: 'Procesador Intel/AMD Ryzen', category: 'technology', baseCost: 500, baseProfit: 55, costMultiplier: 1.18, requires: { type: 'card', id: 'local_servers', level: 5 } },
  { id: 'gpu_mining', name: 'Tarjeta Gráfica GPU RTX', category: 'technology', baseCost: 900, baseProfit: 100, costMultiplier: 1.18, requires: { type: 'card', id: 'aws_cloud', level: 4 } },
  { id: 'cybersecurity', name: 'Disco SSD de Alta Velocidad', category: 'technology', baseCost: 1400, baseProfit: 160, costMultiplier: 1.18, requires: { type: 'card', id: 'smart_contract_audit', level: 5 } },
  { id: 'foxpay_validator', name: 'Mineradora ASIC Bitcoin', category: 'technology', baseCost: 2200, baseProfit: 260, costMultiplier: 1.18, requires: { type: 'card', id: 'gpu_mining', level: 5 } },
  { id: 'senior_devs', name: 'Chip customizado FPGA', category: 'technology', baseCost: 3800, baseProfit: 450, costMultiplier: 1.18, requires: { type: 'card', id: 'foxpay_validator', level: 4 } },
  { id: 'ai_autotap', name: 'Clúster Multiprocesamiento', category: 'technology', baseCost: 6500, baseProfit: 800, costMultiplier: 1.18, requires: { type: 'card', id: 'senior_devs', level: 5 } },
  { id: 'quantum_computing', name: 'Supercomputador Experimental', category: 'technology', baseCost: 12000, baseProfit: 1500, costMultiplier: 1.18, requires: { type: 'card', id: 'ai_autotap', level: 6 } },
  { id: 'metaverse_core', name: 'Granja de Minería Industrial', category: 'technology', baseCost: 25000, baseProfit: 3500, costMultiplier: 1.18, requires: { type: 'card', id: 'quantum_computing', level: 5 } },

  // --- RED (Antes Negocios) ---
  { id: 'brand_registration', name: 'Router de Red Gigabit', category: 'business', baseCost: 300, baseProfit: 32, costMultiplier: 1.18, requires: null },
  { id: 'fintech_license', name: 'Cableado Ethernet Cat8', category: 'business', baseCost: 600, baseProfit: 65, costMultiplier: 1.18, requires: { type: 'card', id: 'brand_registration', level: 4 } },
  { id: 'local_bank_integration', name: 'Internet por Fibra Óptica', category: 'business', baseCost: 1000, baseProfit: 110, costMultiplier: 1.18, requires: { type: 'card', id: 'fintech_license', level: 3 } },
  { id: 'strategic_partnerships', name: 'Enlace Dedicado de Respaldo', category: 'business', baseCost: 1800, baseProfit: 210, costMultiplier: 1.18, requires: { type: 'card', id: 'local_bank_integration', level: 4 } },
  { id: 'kyc_compliance', name: 'Switch Administrable de Red', category: 'business', baseCost: 2800, baseProfit: 330, costMultiplier: 1.18, requires: { type: 'card', id: 'fintech_license', level: 6 } },
  { id: 'dubai_office', name: 'IP Pública Estática', category: 'business', baseCost: 5000, baseProfit: 600, costMultiplier: 1.18, requires: { type: 'card', id: 'strategic_partnerships', level: 5 } },
  { id: 'seed_fund', name: 'Pool de Minería Privada', category: 'business', baseCost: 9000, baseProfit: 1100, costMultiplier: 1.18, requires: { type: 'card', id: 'dubai_office', level: 4 } },
  { id: 'cmc_listing', name: 'Servidor DNS Corporativo', category: 'business', baseCost: 15000, baseProfit: 1900, costMultiplier: 1.18, requires: { type: 'card', id: 'kyc_compliance', level: 8 } },
  { id: 'tier1_exchange', name: 'Enlace Satelital Directo', category: 'business', baseCost: 30000, baseProfit: 4000, costMultiplier: 1.18, requires: { type: 'card', id: 'cmc_listing', level: 5 } },
  { id: 'global_conglomerate', name: 'Data Center Web3 Global', category: 'business', baseCost: 60000, baseProfit: 8500, costMultiplier: 1.18, requires: { type: 'card', id: 'tier1_exchange', level: 7 } }
];
...
async function seedWorldCupMatches() {
  const matches = [
    ...
    // New Matches July 2
    { id: 'wc_2026_07_02_1', team_a: 'España', team_b: 'Austria', flag_a: '🇪🇸', flag_b: '🇦🇹', venue: '16avos de final', match_date: '2026-07-02T15:00:00Z', odds_team_a: 1.26, odds_draw: 5.25, odds_team_b: 10.50 },
    { id: 'wc_2026_07_02_2', team_a: 'Portugal', team_b: 'Croacia', flag_a: '🇵🇹', flag_b: '🇭🇷', venue: '16avos de final', match_date: '2026-07-02T19:00:00Z', odds_team_a: 1.80, odds_draw: 3.60, odds_team_b: 5.10 },
    { id: 'wc_2026_07_02_3', team_a: 'Suiza', team_b: 'Argelia', flag_a: '🇨🇭', flag_b: '🇩🇿', venue: '16avos de final', match_date: '2026-07-02T23:00:00Z', odds_team_a: 2.05, odds_draw: 3.20, odds_team_b: 4.06 },
...
async function buildFoxPayAuditSummary() {
  const players = [];
  const minedMap = new Map();
  const commissionsMap = new Map();
  const rouletteMap = new Map();
  const purchasesMap = new Map();
  const netBetsMap = new Map();

  const addToMap = (target, key, amount) => {
    const normalizedKey = String(key || '').trim();
    if (!normalizedKey) return;
    target.set(normalizedKey, Number(target.get(normalizedKey) || 0) + Number(amount || 0));
  };

  if (!pool) {
    [...foxpayPlayers.values()].forEach((player) => {
      players.push({
        player_id: player.player_id,
        username: player.username || player.player_id,
        token_balance: Number(player.token_balance || 0),
      });
    });
    [...foxpayPlayerDailyStatsMemory.values()].forEach((row) => addToMap(minedMap, row.player_id, row.earned_tokens));
    [...foxpayCommissions.values()].forEach((row) => addToMap(commissionsMap, row.referrer_player_id, row.credited_tokens));
    [...foxpayRouletteSpinsMemory.values()].forEach((row) => addToMap(rouletteMap, row.player_id, row.credited_tokens));
    [...foxpayPurchasesMemory.values()]
      .filter((row) => row.status === 'approved')
      .forEach((row) => addToMap(purchasesMap, row.player_id, row.fox_tokens_paid));

    [...foxpayBetsMemory.values()].forEach((bet) => {
      const match = foxpayMatchesMemory.get(bet.match_id);
      if (!match) return;
      addToMap(netBetsMap, bet.player_id, -Number(bet.amount || 0));
      if (match.status === 'resolved' && match.result === bet.bet_type) {
        let odds = 1;
        if (match.result === 'team_a') odds = Number(match.odds_team_a || 1);
        else if (match.result === 'team_b') odds = Number(match.odds_team_b || 1);
        else if (match.result === 'draw') odds = Number(match.odds_draw || 1);
        addToMap(netBetsMap, bet.player_id, Math.floor(Number(bet.amount || 0) * odds));
      }
    });
  } else {
    const [playersRes, minedRes, commissionsRes, rouletteRes, purchasesRes, betsRes] = await Promise.all([
      pool.query('select player_id, username, token_balance from foxpay_players'),
      pool.query('select player_id, coalesce(sum(earned_tokens), 0) as total from foxpay_player_daily_stats group by player_id'),
      pool.query('select referrer_player_id as player_id, coalesce(sum(credited_tokens), 0) as total from foxpay_commissions group by referrer_player_id'),
      pool.query('select player_id, coalesce(sum(credited_tokens), 0) as total from foxpay_roulette_spins group by player_id'),
      pool.query("select player_id, coalesce(sum(fox_tokens_paid), 0) as total from foxpay_purchases where status = 'approved' group by player_id"),
      pool.query(
        `select b.player_id, b.amount, b.bet_type, m.status as match_status, m.result as match_result, m.odds_team_a, m.odds_team_b, m.odds_draw
         from foxpay_bets b
         join foxpay_matches m on m.id = b.match_id`
      ),
    ]);

    players.push(...playersRes.rows.map((row) => ({
      player_id: row.player_id,
      username: row.username || row.player_id,
      token_balance: Number(row.token_balance || 0),
    })));
    minedRes.rows.forEach((row) => addToMap(minedMap, row.player_id, row.total));
    commissionsRes.rows.forEach((row) => addToMap(commissionsMap, row.player_id, row.total));
    rouletteRes.rows.forEach((row) => addToMap(rouletteMap, row.player_id, row.total));
    purchasesRes.rows.forEach((row) => addToMap(purchasesMap, row.player_id, row.total));
    betsRes.rows.forEach((bet) => {
      addToMap(netBetsMap, bet.player_id, -Number(bet.amount || 0));
      if (bet.match_status === 'resolved' && bet.match_result === bet.bet_type) {
        let odds = 1;
        if (bet.match_result === 'team_a') odds = Number(bet.odds_team_a || 1);
        else if (bet.match_result === 'team_b') odds = Number(bet.odds_team_b || 1);
        else if (bet.match_result === 'draw') odds = Number(bet.odds_draw || 1);
        addToMap(netBetsMap, bet.player_id, Math.floor(Number(bet.amount || 0) * odds));
      }
    });
  }
  ...
  const playerSummaries = players.map((player) => {
    const totalMined = Number(minedMap.get(player.player_id) || 0);
    const totalCommissions = Number(commissionsMap.get(player.player_id) || 0);
    const totalRoulette = Number(rouletteMap.get(player.player_id) || 0);
    const totalPurchases = Number(purchasesMap.get(player.player_id) || 0);
    const netBets = Number(netBetsMap.get(player.player_id) || 0);
    const totalCorrect = totalMined + totalCommissions + totalRoulette + totalPurchases + netBets;
    const totalReal = Number(player.token_balance || 0);
    const difference = totalReal - totalCorrect;
    ...
    return {
      ...
      components: {
        ...
        roulette: totalRoulette,
        purchases: totalPurchases,
        net_bets: netBets,
      },
    };
  }).sort((left, right) => {
    if (right.difference !== left.difference) return right.difference - left.difference;
    return String(left.username || '').localeCompare(String(right.username || ''));
  });

  const totals = playerSummaries.reduce((acc, row) => {
    acc.total_correct += Number(row.total_correct || 0);
    acc.total_real += Number(row.total_real || 0);
    acc.difference += Number(row.difference || 0);
    if (row.difference > 0) acc.players_with_excess += 1;
    return acc;
  }, {
    total_correct: 0,
    total_real: 0,
    difference: 0,
    players_with_excess: 0,
  });

  return { playerSummaries, totals };
}
...
async function handleFoxPayAdminMatchAuditDuplicates(request, response, url) {
  ...
  try {
    ...
    if (!pool) {
      // In-memory fallback
      if (!matchId) {
        const auditSummary = await buildFoxPayAuditSummary();
        const matches = [...foxpayMatchesMemory.values()]
          ...
          .map(m => ({
            ...
            status: m.status,
            result: m.result,
            odds_team_a: m.odds_team_a,
            odds_team_b: m.odds_team_b,
        ...
        return sendJson(response, 200, {
          ok: true,
          matches,
          player_summaries: auditSummary.playerSummaries,
          summary_totals: auditSummary.totals,
        });
      } else {
        const match = foxpayMatchesMemory.get(matchId);
        if (!match) {
          return sendJson(response, 404, { ok: false, error: 'match_not_found' });
        }
        // If result is not set yet, default to team_a for previewing
        const result = match.result || 'team_a';
        let odds = 1.00;
        ...
        const bets = [...foxpayBetsMemory.values()]
          .filter(b => b.match_id === matchId && b.bet_type === result)
          .map(b => {
            const player = foxpayPlayers.get(b.player_id) || {};
            const expectedPayout = Math.floor(Number(b.amount) * odds);
            return {
              player_id: b.player_id,
              username: player.username || b.player_id,
              bet_amount: Number(b.amount),
              odds: odds,
              expected_payout: expectedPayout
            };
          });
        return sendJson(response, 200, { ok: true, match, winners: bets });
      }
    } else {
      if (!matchId) {
        const auditSummary = await buildFoxPayAuditSummary();
        ...
        const bRes = await pool.query(
          `select b.player_id, p.username, b.amount as bet_amount 
           from foxpay_bets b 
           join foxpay_players p on b.player_id = p.player_id 
           where b.match_id = $1 and b.bet_type = $2`,
          [matchId, result]
        );
